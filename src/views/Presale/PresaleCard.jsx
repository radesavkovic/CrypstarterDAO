...
export function PresaleCard({address, currentExchangeRate, currentBonusRate, cstPurchaseBalance, cstpTotalSupply, cstInCirculation, cstpBalance, inputBUSDAmount, 
    ...
    return (
        ...
        <Box display="flex">
          <CardHeader title="Xodus Presale Event" />
        </Box>
        <Grid container direction="column" spacing={2}>
          <Grid item>
            <Grid container spacing={2} alignItems="flex-end">
              <Grid item xs={12} sm={12} md={12} lg={12}>
                <Typography align="right">XOD Price: <b>${currentExchangeRate | 0}</b></Typography>
              </Grid>
              <Grid item xs={12} sm={12} md={12} lg={12}>
                <Typography align="right">Bonus: <b>{(currentBonusRate | 0) + '%' } </b></Typography>
              </Grid>
              <Grid item xs={12} sm={12} md={12} lg={12}>
                <Typography align="right">Purchased XOD: <b>{cstPurchaseBalance.toFixed(2) | 0}</b></Typography>
              </Grid>
            </Grid>
            <Grid container spacing={2} alignItems="flex-end">
